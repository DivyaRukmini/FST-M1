...
public class Activity10 {
    ...
    public static List<List<String>> readExcelOwn() throws IOException {
    	FileInputStream file1 = new FileInputStream("source.xlsx");
    ...
    public static Object[][] signUpInfo() {
        ...
        System.out.println("Inside source path");
        try {
			readExcelOwn();
		} catch (IOException e) {
    ...
    public void registerTest(List<String> rows) throws InterruptedException {
        ...
        driver.findElement(By.name("event-date")).sendKeys(formattedDate.replaceAll("-", ""));
